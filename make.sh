...
aarch64-linux-gnu-g++ -Wl,-rpath -Wl,'$ORIGIN' -g -o ../demosimplest codeimg.cpp common_toupcam.cpp Error.cpp main.cpp rtp.cpp socket.cpp toupcamcfg.cpp wificfg.cpp -I/home/cht/test/lib/lib/include/ -L/home/cht/test/lib/lib/lib -ltoupcam -lavformat -lavcodec -lswscale -lswresample -lavutil -lm -lz -pthread -ljpeg -lx264 #-llzma
cd -
